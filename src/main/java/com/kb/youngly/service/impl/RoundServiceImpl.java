...
public class RoundServiceImpl implements RoundService {
    ...
    public CreateRoundResponse createRound(String userId, String groupId, CreateRoundRequest request) {
        ...
        RoundVO round = RoundVO.builder()
                ...
                .roundNo(roundNo)
                .startDate(startDate)
                .endDate(startDate.plusDays(group.getRoundCycleDays() - 1L))
    ...
    @Override
    @Transactional(readOnly = true)
    public List<RoundUserResponse> getRoundUsers(Long roundId) {
        ...
        return roundMapper.findRoundUsers(roundId);
    }
}
