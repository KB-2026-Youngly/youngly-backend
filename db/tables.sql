...
CREATE TABLE `notifications` (
                                 ...
                                 `user_id`	VARCHAR(50)	NOT NULL,
                                 `notification_type`	ENUM( 'GROUP_INVITE', 'APPROVAL_REQUEST', 'APPROVED', 'REJECTED', 'LEFT', 'ROUND_START', 'ROUND_END', 'SETTLEMENT_COMPLETED', 'REMINDER', 'POST_UPLOAD', 'POKE' )	NOT NULL,
